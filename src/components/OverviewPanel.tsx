      ...
      <div className="grid grid-cols-1 tablet:grid-cols-12 gap-3 tablet:gap-4">
        ...
        <div className="col-span-12 tablet:col-span-8 space-y-3 tablet:space-y-4">
          ...
          {activeSessions.length > 0 && (
            <div className="glass-soft rounded-3xl p-4 shadow-2xl shadow-black/35 space-y-3 overflow-visible">
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-[10px] uppercase tracking-wide text-cyan-400/80 font-medium">
                  Status
                </span>
              </div>
              <div className="flex flex-col gap-4">
                {activeSessions.map((session) => {
                  ...
                  return (
                    <div
                      key={session.name}
                      className="glass-soft rounded-2xl p-4 shadow-xl shadow-black/30 flex flex-col gap-3"
                    >
        ...
        <div className="col-span-12 md:col-span-4 flex flex-row md:flex-col gap-3">
          ...
          <div className="hidden md:block glass-soft rounded-2xl p-3 shadow-xl shadow-black/30">
          ...
          <button
            ...
            className="flex-1 glass-soft rounded-2xl p-3 shadow-xl shadow-black/30 hover:border-emerald-400/40 transition-all text-left w-full"
          >
            <div className="flex items-center justify-between mb-1.5">
